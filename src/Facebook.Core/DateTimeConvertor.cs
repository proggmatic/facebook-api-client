...
namespace Facebook.Api.Client
{
    ...
    public static class DateTimeConvertor
    {
        ...
        {
            if (!double.TryParse(unixTime, out var d))
        ...
        public static double ToUnixTime(DateTime dateTime) => Math.Round((dateTime.ToUniversalTime() - Epoch).TotalSeconds);
        ...
        /// <param name="dateTime">The date time.</param>
        /// <returns>The unix date time.</returns>
        public static double ToUnixTime(DateTimeOffset dateTime) => (dateTime.ToUniversalTime() - Epoch).TotalSeconds;
        ...
        /// </returns>
        public static string ToIso8601FormattedDateTime(DateTime dateTime) => dateTime.ToUniversalTime().ToString(Iso8601Format[0], CultureInfo.InvariantCulture);
        ...
        public static DateTime FromIso8601FormattedDateTime(string iso8601DateTime)
        {
            if (string.IsNullOrEmpty(iso8601DateTime))
                throw new ArgumentNullException(nameof(iso8601DateTime));
